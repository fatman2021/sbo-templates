...
doinst_sh_template = [
    '##########################################################################'
    '#####',
    '#             COPY A TEMPLATE AND PASTE IT INTO THE TEXT EDITOR           '
    '    #',
    ...
    'chroot . /usr/bin/gio-querymodules @LIBDIR@/gio/modules/ 1> /dev/null 2> '
    '/dev/null',
    '',
    'if [ -x /usr/bin/install-info ]; then',
    '  chroot . /usr/bin/install-info --info-dir=/usr/info /usr/info/blah.gz '
    '2> /dev/null',
    'fi',
]
